...
return new class extends Migration
{
    public function up(): void
    {
        ...
        commerce_schema_create_if_missing(config('events.database.tables.event_notification_batches', 'event_notification_batches'), function (Blueprint $table) use ($jsonType): void {
