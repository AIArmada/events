...
return new class extends Migration
{
    public function up(): void
    {
        ...
        commerce_schema_create_if_missing(config('events.database.tables.event_approval_requests', 'event_approval_requests'), function (Blueprint $table) use ($jsonType): void {
