...
return new class extends Migration
{
    public function up(): void
    {
        ...
        commerce_schema_create_if_missing(config('events.database.tables.event_management_assignments', 'event_management_assignments'), function (Blueprint $table) use ($jsonType): void {
