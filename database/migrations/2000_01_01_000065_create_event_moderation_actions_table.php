...
return new class extends Migration
{
    public function up(): void
    {
        ...
        commerce_schema_create_if_missing(config('events.database.tables.event_moderation_actions', 'event_moderation_actions'), function (Blueprint $table) use ($jsonType): void {
