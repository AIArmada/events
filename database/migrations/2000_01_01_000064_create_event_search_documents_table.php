...
return new class extends Migration
{
    public function up(): void
    {
        ...
        commerce_schema_create_if_missing(config('events.database.tables.event_search_documents', 'event_search_documents'), function (Blueprint $table) use ($jsonType): void {
