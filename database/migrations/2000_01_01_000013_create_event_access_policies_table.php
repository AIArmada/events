...
return new class extends Migration
{
    public function up(): void
    {
        ...
        commerce_schema_create_if_missing(config('events.database.tables.event_access_policies', 'event_access_policies'), function (Blueprint $table) use ($jsonType): void {
