...
return new class extends Migration
{
    public function up(): void
    {
        ...
        commerce_schema_create_if_missing(config('events.database.tables.event_notification_deliveries', 'event_notification_deliveries'), function (Blueprint $table) use ($jsonType): void {
