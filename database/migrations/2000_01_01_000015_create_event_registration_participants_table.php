...
return new class extends Migration
{
    public function up(): void
    {
        ...
        commerce_schema_create_if_missing(config('events.database.tables.event_registration_participants', 'event_registration_participants'), function (Blueprint $table) use ($jsonType): void {
