...
return new class extends Migration
{
    public function up(): void
    {
        ...
        commerce_schema_create_if_missing(config('events.database.tables.event_attendance_logs', 'event_attendance_logs'), function (Blueprint $table) use ($jsonType): void {
