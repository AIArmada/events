...
return new class extends Migration
{
    public function up(): void
    {
        ...
        commerce_schema_create_if_missing(config('events.database.tables.event_availability_blocks', 'event_availability_blocks'), function (Blueprint $table) use ($jsonType): void {
