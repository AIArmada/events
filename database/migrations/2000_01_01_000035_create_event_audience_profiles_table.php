...
return new class extends Migration
{
    public function up(): void
    {
        ...
        commerce_schema_create_if_missing(config('events.database.tables.event_audience_profiles', 'event_audience_profiles'), function (Blueprint $table) use ($jsonType): void {
