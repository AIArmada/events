...
return new class extends Migration
{
    public function up(): void
    {
        ...
        commerce_schema_create_if_missing(config('events.database.tables.event_time_expressions', 'event_time_expressions'), function (Blueprint $table) use ($jsonType): void {
