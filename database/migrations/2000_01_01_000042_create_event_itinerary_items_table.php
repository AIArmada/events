...
return new class extends Migration
{
    public function up(): void
    {
        ...
        commerce_schema_create_if_missing(config('events.database.tables.event_itinerary_items', 'event_itinerary_items'), function (Blueprint $table) use ($jsonType): void {
