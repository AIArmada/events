 ...
 */
class EventSubLocation extends Model implements Auditable
{
    ...
    {
        return config('events.database.tables.sub_locations', 'event_sub_locations');
    }
    ...
    {
        return $this->hasMany(Occurrence::class, 'sub_location_id');
    }
}
